...
\subsection{\fontsize{12}{1} \selectfont{\textbf{Obter 2\textordfeminine \space Via de Conta}}}
...
\subsection{\fontsize{12}{1} \selectfont{\textbf{Informar Falta de Água}}}
...
\subsection{\fontsize{12}{1} \selectfont{\textbf{Solicitar Restabelecimento da Ligação de Água}}}
...
\section{\fontsize{12}{1} \selectfont{\textbf{Execução dos Cenários de Teste}}}
