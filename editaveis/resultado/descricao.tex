\chapter[Demonstração da Suíte de Testes Automatizados]{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Demonstração da Suíte de Testes Automatizados}}}}
...
\section{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Preparação do Ambiente de teste}}}}
...
\section{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Cenários de Teste}}}}
...
\subsection{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Obter 2\textordfeminine \space Via de Conta}}}}
...
\subsection{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Informar Falta de Água}}}}
...
\subsection{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Solicitar Restabelecimento da Ligação de Água}}}}
...
\section{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Execução dos Cenários de Teste}}}}
