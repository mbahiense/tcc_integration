\chapter[Experimentação Utilizando a Suíte de Testes Automatizados]{\textbf{E}xperimentação \textbf{U}Utilizando a \textbf{S}uíte de \textbf{T}estes \textbf{A}utomatizados}
