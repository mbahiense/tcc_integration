\chapter[Middleware: GSAN e Asterisk]{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Middleware: Gsan e Asterisk}}}}
...
\section{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Etapas da Integração}}}}
