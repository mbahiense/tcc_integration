...
\subsection{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Asterisk Instalação}}}}
...
\subsection{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Asterisk - Detalhamento Técnico}}}}
