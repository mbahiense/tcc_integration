...
%\includegraphics[scale=1]{figuras/LigacoesReclamacoes}
\centering Figura 2: Implantações do Sistema GSAN \\
\centering Fonte: Portal do Software Público Brasileiro, 2014
...
\begin{table}[htb]
	...
	\end{tabular}
\end{table}
\centering Tabela 2: Principais Atributos do Imóvel \\
...
\textit{IMAGEM PENDENTE} \\
%\includegraphics[scale=1]{figuras/gsan_arquitetura}
\centering Figura 3: Arquitetura Detalhada do Sistema GSAN \\
\centering Fonte: Autoria Própria
...
\textit{IMAGEM PENDENTE} \\
%\includegraphics[scale=1]{figuras/build_properties}
\centering Figura 4: Exemplo de configuração do script build \\
\centering Fonte: Autoria Própria
...
\textit{IMAGEM PENDENTE} \\
%\includegraphics[scale=1]{figuras/build_ant}
\centering Figura 5: Execução do script de build  \\
\centering Fonte: Autoria Própria	
...
\textit{IMAGEM PENDENTE} \\
%\includegraphics[scale=1]{figuras/executando_jboss}
\centering Figura 6: Executando o sistema GSAN  \\
\centering Fonte: Autoria Própria
...
\textit{IMAGEM PENDENTE} \\
%\includegraphics[scale=1]{figuras/gsan_online}
\centering Figura 7: Acessando página inicial do Sistema   \\
\centering Fonte: Autoria Própria
