...
\chapter{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Processo de configuração da JDK na IDE de desenvolvimento}}}}
...
\chapter{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Configurar variável de ambiente do servidor de aplicação Jboss}}}}
...
\chapter{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Configuração do Fluxo da URA}}}}
...
\chapter{\fontsize{12}{1} \selectfont{\textbf{\uppercase{Registros de Atendimentos Gerados}}}}
