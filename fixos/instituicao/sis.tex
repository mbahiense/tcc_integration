...
\preambulo{Monografia apresentada ao curso de graduação em Sistemas de Informação da Facupi (Instituto de Ensino Superior Fucapi), como requisito parcial para obtenção do Título de Bacharel em Sistemas de Informação.}
% Proposta de ITCC
