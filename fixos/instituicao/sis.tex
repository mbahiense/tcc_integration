...
\preambulo{\fontsize{10}{1}\selectfont {Monografia apresentada ao curso de graduação em Sistemas de Informação da Facupi (Instituto de Ensino Superior Fucapi), como requisito parcial para obtenção do Título de Bacharel em Sistemas de Informação Área de Concentração: Desenvolvimento e Análise de software.}}
% Proposta de ITCC
